...
public class SourceAspect {
     ...
     * @return
     */
    @AfterReturning(value = "execution(* com.kuxue.service.bam.process.SourceNodeService.saveSourceNode(..))")
     ...
     * @return
     */
    @AfterReturning(value = "execution(* com.kuxue.service.bam.BamCourseService.updateCatalogThrough(..))")
