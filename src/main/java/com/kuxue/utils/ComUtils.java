...
import com.kuxue.common.utils.RegexUtils;
import com.kuxue.sso.e2.util.AESX3;
...
public class ComUtils {
	...
	public static String getDefaultPoto() {
		return "resources/images/default-face-180.png";
	}

	public static String getFileUrl(String fdId, String fileName) {
		return "http://localhost:8080/lark/viewer/index.jsp?fileName=" +  fileName;
	}
