...
<%@ page import="com.kuxue.webservice.client.ad.ADApi" %>
<%@ page import="com.kuxue.webservice.client.ad.ADApiSoap" %>
<%@ page import="com.kuxue.webservice.client.ad.UserInfo" %>
<%@ page import="com.kuxue.webservice.client.ad.ExtensionDataObject" %>
<%--
